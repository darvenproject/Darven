      ...
      <div className="h-screen w-full snap-start snap-always relative bg-white">
        <div className="container mx-auto px-6 h-full flex flex-col justify-center items-center">
          <div className="text-center w-full">
            {/* Brand Name */}
            <h2 className="text-4xl font-bold mb-8 tracking-wider text-blue-700">SHOPDARVEN</h2>
            
            {/* Brand Description */}
            <p className="text-sm font-light text-blue-500 leading-relaxed max-w-xs mx-auto mb-8">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8 text-left max-w-xs mx-auto">
              <div>
                <h3 className="text-sm font-light tracking-wide text-blue-700 mb-3 uppercase">Shop</h3>
                <ul className="space-y-2">
                  <li><Link href="/ready-made" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">Ready Made</Link></li>
                  <li><Link href="/stitch-your-own" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">Stitch Your Own</Link></li>
                  <li><Link href="/fabric" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">Fabrics</Link></li>
                  <li><Link href="/cart" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">Cart</Link></li>
                  <li><Link href="/about" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">About Us</Link></li>
                  <li><Link href="/size-chart" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">Size Chart</Link></li>
                  <li><Link href="/return-exchange-policy" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">Return &amp; Exchange</Link></li>
                </ul>
              </div>

              <div>
                <h3 className="text-sm font-light tracking-wide text-blue-700 mb-3 uppercase">Contact</h3>
                <ul className="space-y-2">
                  <li><Link href="/contact" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">Contact Us</Link></li>
                  <li className="text-sm font-light text-blue-500">Karachi, Pakistan</li>
                  <li>
                    <a href="mailto:shopdarven@gmail.com" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">
                      shopdarven@gmail.com
                    </a>
                  </li>
                  <li>
                    <a href="https://www.instagram.com/shopdarven/" target="_blank" rel="noopener noreferrer" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">
                      Instagram
                    </a>
                  </li>
                  <li>
                    <a href="https://www.facebook.com/profile.php?id=61580410082761" target="_blank" rel="noopener noreferrer" className="text-sm font-light text-blue-500 hover:opacity-70 transition-opacity">
                      Facebook
                    </a>
                  </li>
                </ul>
            ...
            {/* Copyright */}
            <div className="border-t border-blue-100 pt-6 max-w-sm mx-auto">
