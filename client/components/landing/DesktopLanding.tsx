            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 mb-16 max-w-6xl mx-auto">
              ...
              <div>
                ...
                <ul className="space-y-3 text-base md:text-lg">
                  ...
                  <li>
                    <a href="mailto:shopdarven@gmail.com" className="hover:text-gray-600 transition-colors">shopdarven@gmail.com</a>
                  </li>
                  <li className="pt-2">
                    <a href="https://www.instagram.com/shopdarven/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors">Instagram: ShopDarven</a>
                  </li>
                  <li>
                    <a href="https://www.facebook.com/profile.php?id=61580410082761" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors">Facebook: ShopDarven</a>
                  </li>
                </ul>
              </div>
            </div>
