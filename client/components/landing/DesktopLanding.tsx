  ...
  return (
    ...
    >
      ...
      <div className="h-screen w-full snap-start snap-always relative bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto px-6 lg:px-12 xl:px-24 h-full flex flex-col justify-center items-center text-white max-w-7xl">
          <motion.div
          ...
          >
            ...
            {/* Quick Links */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-16 max-w-5xl mx-auto">
              <div>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-semibold mb-6">Company</h3>
                <ul className="space-y-3 text-base md:text-lg">
            ...
            <div className="flex justify-center space-x-8 mb-12">
              <a href="#" className="hover:text-gray-300 transition-colors transform hover:scale-110 duration-200" aria-label="Facebook">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" className="hover:text-gray-300 transition-colors transform hover:scale-110 duration-200" aria-label="Instagram">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="hover:text-gray-300 transition-colors transform hover:scale-110 duration-200" aria-label="Twitter">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Copyright */}
            <div className="border-t border-gray-700 pt-10 max-w-4xl mx-auto w-full">
              <p className="text-gray-400 text-base md:text-lg">
                © {new Date().getFullYear()} DARVEN. All rights reserved.
              </p>
              <div className="mt-6 space-x-6 text-base md:text-lg">
