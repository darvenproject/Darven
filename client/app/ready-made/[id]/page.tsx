    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <Link href="/ready-made" className="text-gray-600 hover:text-gray-900:text-white font-bold">
            ← Back to products
          </Link>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border-2 border-gray-200">
            ...
            <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
              ...
              <button
                ...
                className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-gray-100:bg-gray-800 transition-colors"
              >
                  ...
                  <table className="w-full border-2 border-gray-200 rounded-xl overflow-hidden">
                    <thead>
                      <tr className="bg-gray-900">
                        <th className="px-4 py-3 text-left text-sm font-black text-white">Size</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Collar</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Shoulder</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Chest</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Sleeves</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Length</th>
                      </tr>
                    </thead>
                    <tbody>
                      {kameezSizeChart.map((row, index) => (
                        <tr
                          ...
                          } hover:bg-gray-100:bg-gray-700 transition-colors`}
                        >
                          <td className="px-4 py-3 text-left font-black text-gray-900 border-r border-gray-200">
                            {row.size}
                          </td>
                  ...
                  <table className="w-full border-2 border-gray-200 rounded-xl overflow-hidden">
                    <thead>
                      <tr className="bg-gray-900">
                        <th className="px-4 py-3 text-left text-sm font-black text-white">Size</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Length</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Waist</th>
                        <th className="px-4 py-3 text-center text-sm font-black text-white">Hips</th>
                      </tr>
                    </thead>
                    <tbody>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  className="group relative px-4 py-2 rounded-xl bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-900 hover:to-gray-800:from-white:to-gray-100 border-2 border-gray-300 hover:border-gray-900:border-white transition-all duration-300 hover:scale-105 hover:shadow-lg"
                >
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      <FiInfo className="w-4 h-4 text-gray-700 group-hover:text-white:text-gray-900 transition-colors" />
                      <div className="absolute -top-1 -right-1 w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
                    </div>
                    <span className="text-sm font-black text-gray-700 group-hover:text-white:text-gray-900 transition-colors">
                      Size Chart
                    </span>
                  </div>
                </button>
                  ...
                  <button
                    ...
                    className={`py-3 px-4 rounded-xl border-2 font-black transition-all hover:scale-105 ${
                      selectedSize === size
                        ...
                        : 'border-gray-300 bg-white text-gray-900 hover:border-gray-500:border-gray-500 hover:shadow-md'
                    }`}
                  >
                    {size}
                  </button>
              ...
              <div className="flex gap-4 min-w-max">
                {relatedProducts.map((relatedProduct) => (
                  <Link key={relatedProduct.id} href={`/ready-made/${relatedProduct.id}`}>
                    <div className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border-2 border-gray-200 hover:border-gray-900:border-white hover:-translate-y-2 w-[280px]">
                      ...
                      <div className="p-4 bg-gray-50 group-hover:bg-white:bg-gray-800 transition-colors">
                        <h3 className="text-base font-black text-gray-900 mb-2 line-clamp-1 group-hover:text-gray-600:text-gray-300 transition-colors">
                          {relatedProduct.name}
                        </h3>
