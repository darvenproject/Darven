...
export const metadata: Metadata = {
  ...
  description: 'Browse our premium ready-made kurta pajama and shalwar kameez collection. Available in Wash n Wear, Cotton and Boski fabrics. Shop traditional Pakistani clothing.',
