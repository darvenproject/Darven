...
export default function NewCollectionDetailPage() {
  ...
  const fetchProduct = async () => {
    try {
      const response = await apiClient.getNewCollectionProduct(params.id as string)
  ...
  const fetchRelatedProducts = async () => {
    try {
      const response = await apiClient.getNewCollectionProducts()
  ...
  if (!product) return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="text-center">
        ...
        <Link href="/new-collection" className="text-gray-600 hover:text-gray-900 font-bold">← Back to New Collection</Link>
      </div>
    </div>
  )
      ...
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm">
            <Link href="/new-collection" className="text-gray-600 hover:text-gray-900 font-bold">New Collection</Link>
