                    ...
                    <div className="p-4 bg-gray-50 group-hover:bg-white:bg-gray-800 transition-colors">
                        ...
                        <div className="mb-3">
                          <div className="flex flex-wrap gap-1">
                            {fabric.colors.slice(0, 3).map((color, idx) => (
                              <span
                                key={idx}
                                className="text-xs px-2 py-1 bg-gray-200 text-gray-700 rounded-md font-bold"
                              >
                                {color}
                              </span>
                            ))}
                            {fabric.colors.length > 3 && (
                              <span className="text-xs px-2 py-1 text-gray-500 font-bold">
                                +{fabric.colors.length - 3}
                              </span>
                            )}
                          </div>
                      ...
                      <div className="flex items-end justify-between mt-4">
                        <div>
                          ...
                          <span className="text-sm text-gray-500 font-bold">/m</span>
